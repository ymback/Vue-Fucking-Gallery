...
export default {
  ...
  methods: {
    ...
    imageLoaded (imageObj) {
      ...
      if (firstTime) {
        if (this.initLoadFinishCallback !== null) {
          // Do callback
      ...
      if (this.photoLoadSuccessCallback !== null) {
        // Do callback
        this.photoLoadSuccessCallback()
      }
    ...
    redrawCanvas (forceRedraw) {
      if (this.animationRunning) {
        ...
        if (this.animateEndCallback !== null) {
    ...
    startAnimation () {
      ...
      if (this.animateBeginCallback !== null) {
        // Do callback
